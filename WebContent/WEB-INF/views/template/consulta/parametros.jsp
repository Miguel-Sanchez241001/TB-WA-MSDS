 ...
 <div class="form-group">
										<table  width="100%" class="form-group">
														...
														<tr>
															...
															<td width="30%" align="left">
																<select name="cpConsulta" class="Editar Requerido" style="font-size: 14px">
																 ...
																 <input type="button" class="buttonCls" submit="true" style="width: 90px" value="Insertar"  onclick="iniciarSesion();" />
					            							     	
																	 <input type="button" class="buttonCls" submit="true" style="width: 90px" value="Actualizar"  onclick="iniciarSesion();" />
					            							     	 <input type="button" class="buttonCls" submit="true" style="width: 90px" value="Eliminar"  onclick="iniciarSesion();" />
															...
															<label for="email" style="font-size: 14px">Funcionalidad:</label>
														...
														<tr>
															...
															<td width="30%" align="left" > <label for="email" style="font-size: 14px">Plataforma:</label>
															...
															<td width="70%" align="left" style="font-size: 14px">
																...
																<tr>
																<td width="20%" align="left">
															<label for="email" style="font-size: 14px">Persona Responsable:</label>
															</td>

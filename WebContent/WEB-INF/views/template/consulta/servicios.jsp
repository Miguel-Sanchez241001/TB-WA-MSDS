...
<form id="frmRegistro" name="frmRegistro" method="post" action='<c:out value="${url}"/>aplicacionreg/' runat="server">


	

<div class="container">
  <h2 style="font-weight: bold">REGISTRO DE SERVICIOS DEL BN</h2>
...
<table  width="100%" class="form-group">
 ...
 <tr>
   <td width="35%" align="left" > <label for="email" style="font-size: 14px">Tipo de Servicio:</label>
   </td>
															
   <td width="55%" align="left">
 <select name="tipoServ" id="tipoServ" class="Editar Requerido" style="font-size: 14px">
		<option value="Microservicio" ${cpConsulta=='N' ? 'selected' : ''}>Microservicio</option>
		<option value="SOAP" ${cpConsulta=='N' ? 'selected' : ''}>SOAP</option>
		<option value="REST" ${cpConsulta=='S' ? 'selected' : ''}>REST</option>
</select>
  </td>
 </tr>
 
 <tr>
  <td width="35%" align="left" > <label for="email" style="font-size: 14px; ">Nombre del Servicio:</label>
  </td>
															
  <td width="55%"  >
	  <input type="text" id="nomServicio" name="nomServicio" size="4" style="width: 500px; font-size: 11px"  maxlength="100" class="uppercase"/>
  </td>
 </tr>
 
  <tr>
  <td width="35%" align="left" > <label for="email" style="font-size: 14px; ">Descripción del Servicio:</label>
  </td>
															
  <td width="55%"  >
	 <textarea id="desServicio" name="desServicio" style="height: 50px; width: 500px; font-size: 11px"  maxlength="300" class="uppercase"></textarea>
  </td>
 </tr>
	
	 <tr>
   <td width="35%" align="left" >
	<label for="email" style="font-size: 14px">Dominio:</label>
   </td>
   <td width="55%" align="left" style="font-size: 14px">
	  <select id="dominio" name="dominio" style="font-size: 13px">
...
<tr>
    <td colspan="2" align="left">
			...
			<input type="button" class="cssButton-gris-larger-Retornar" submit="true" style="width: 140px" value="REGISTRAR" onclick="registrar();" />

...
<body>
	...
	<div class="container-box">
		...
		<div class="box-archivo  ">
			...
			<form class="box" action="<%=request.getContextPath()%>/buscarlog"
				method="post">
				<div class="form-item">
				...
				<div id="box-btn" class="form-item">
					<button type="submit" class="btn-red" id="btn_formulario">Consultar</button>
				</div>
			</form>
			...
			<c:if test="${not empty logs}">
				<div class="export-links">
					...
					<a href="<%=request.getContextPath()%>/logaudi/exportExcel"> <img
						src="<c:url value='/assets/img/icon/excel.jpg'/>"
						alt="Exportar a Excel" style="width: 24px; height: 24px;"></a>
				</div>
				<div class="box-table">
					<display:table class="headerDisplay" name="logs" pagesize="10"
						id="item" requestURI="">
						...
						<display:column property="aplicacion" title="Aplicacion" />
					</display:table>
